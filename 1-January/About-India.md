...
- 26 January 1950 
- Constitution means -> ruleBook of a country 

## 3 - Area of India
- Total area: 3.28 million sq km
- 7th largest country in the world
- Latitude: From 8°4′ N to 37°6′ N
- Longitude: From 68°7′ E to 97°25′ E 

## 4 - Population of India ( According to 2011)
-  Total population in india : 121,01,93,422

## 5 - Population for every state in India 
...
## 6 - States and It Captial's (28 states)
...
## 7.1 - Himalayan River System (Perennial Rivers)
...
#  Major Tributaries (India):
   ...
   Sutlej: Tibet → Himachal Pradesh → Punjab → Pakistan

#  7.1.2 - Ganga River System (Bay of Bengal) - 2,525 km
   Flow -  Uttarakhand → Uttar Pradesh → Bihar → Jharkhand → West Bengal → Bay of Bengal
#  Major Tributaries:
   Yamuna: Uttarakhand → Haryana → Delhi → Uttar Pradesh (joins at Prayagraj)
   Ghaghara: Tibet → UP → Bihar
   Gandak: Nepal → Bihar
   Kosi: Nepal → Bihar ("Sorrow of Bihar")
   Son: MP → UP → Bihar
   Damodar: Jharkhand → West Bengal

#  7.1.3 - Brahmaputra River System -  2,900 KM
   Flow - Arunachal Pradesh → Assam → Bangladesh → Bay of Bengal
#  Major Tributaries:
   Dibang
   Lohit
   Subansiri
...
#  7.2 - Peninsular River System (Seasonal Rivers)
#  7.2.1 - Mahanadi (858 km)
        - Chhattisgarh → Odisha → Bay of Bengal
#  7.2.2 - Godavari (1,465 km) (Longest Peninsular River)
        - Maharashtra → Telangana → Andhra Pradesh → Bay of Bengal
#  7.2.3 - Krishna (1,400 km)
        - Maharashtra → Karnataka → Telangana → Andhra Pradesh → Bay of Bengal
#  7.2.4 - Kaveri (760 km)
        ➡ Karnataka → Tamil Nadu → Bay of Bengal
#  7.2.5 - 8. Narmada (1,312 km)
        - Madhya Pradesh → Gujarat → Arabian Sea
#  7.2.6 - Tapi / Tapti (724 km)
        - Madhya Pradesh → Maharashtra → Gujarat → Arabian Sea

## 8 - Borders
- Land borders with India : Pakistan, China, Nepal, Bhutan, Bangladesh, Myanmar
...
## 10 - Islands
- island: Andaman and Nicobar Islands, Lakshadweep
...
## 12 - Presidents and Prime Ministers from independence
